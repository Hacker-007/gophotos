		...
		<html lang="en">
			<body>
				...
				>
					...
					>
						<header className="lg:px-4 w-full space-y-2 bg-primary px-3 pb-4">
							<div>
								<h2 className="text-lg font-medium">
									Heading about GoPhotos
								</h2>
								<h3 className="text-sm text-gray-600">
									Subheading about GoPhotos that elaborates
									what the main heading says. This can be long
									as well.
								</h3>
							</div>
					...
					<footer className="lg:px-4 bg-primary px-3 py-10">
						...
						<div className="mt-3 grid gap-4 w-96">
