    ...
    <html lang="en">
      <body>
        <div className={spaceGrotesk.className}>
          ...
          >
            <header className="flex flex-col gap-2 bg-primary px-3 pb-4">
              <div className="flex aspect-square w-full flex-col justify-between rounded-md border border-gray-400 p-2">
                <h2 className="text-lg font-medium">Heading about GoPhotos</h2>
                <h3 className="text-xs text-gray-600">
                  Subheading about GoPhotos that elaborates what the main
                  heading says. This can be long as well.
                </h3>
              </div>
          ...
          <footer className="bg-primary px-3 py-10">
            <h1 className="font-medium">GoPhotos</h1>
            <p className="text-xs text-gray-600">
              Another subheading that talks about GoPhotos.
            </p>
            ...
            <div className="mt-3 grid grid-cols-2">
              ...
              <div className="flex flex-col space-y-1">
                ...
                <Link href="tel:+4253756070" className="text-sm">
                  Phone
                </Link>
                <Link href="mailto:help@gophotos.us" className="text-sm">
                  Email
                </Link>
              </div>
            </div>
