...
export default function PhotographerProfile({
	...
	return (
		<Dialog className="relative z-10" open={isOpen} onClose={close}>
			...
			<Dialog.Panel className="fixed bottom-0 h-full w-full max-w-7xl lg:left-1/2 lg:-translate-x-1/2 space-y-4 overflow-y-auto bg-white p-4 sm:p-8 lg:p-10">
				...
				<div className="grid gap-4 sm:grid-cols-[1fr_auto] lg:grid-cols-[40rem_1fr]">
					<div className="sm:col-start-1 sm:row-start-1 max-w-3xl">
						<Carousel className='' imageUrls={portfolioUrls} />
					...
					<div className="sm:col-start-2 sm:w-56 md:w-80 lg:w-full h-min sm:row-start-1 sm:flex-col flex sm:items-start items-center justify-between rounded-md border border-gray-200 p-2">
						<div>
				...
				<div className='max-w-xl'>
					...
					<p className="mt-1 text-sm text-gray-600">
						...
						elit. Voluptatem, quae. Asperiores ratione facilis
						praesentium animi recusandae, nihil incidunt sed
						aperiam. Facere inventore, ratione harum quibusdam
