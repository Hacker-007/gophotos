...
export default function RequestQuote() {
  ...
  return (
    <>
      <Button
        className="rounded-md bg-accent px-3 py-2 text-sm font-medium text-secondary"
      ...
      >
        <Dialog.Panel className="fixed bottom-0 z-20 h-full w-full space-y-4 overflow-y-auto bg-white p-4">
          ...
          <div className={spaceGrotesk.className}>
            <div>
              <h3 className="font-medium capitalize text-2xl">Request a quote</h3>
              <p className="mt-3 text-sm">
                Great! There is some information that we need to send an initial
                quote request.
              </p>
            </div>
            <form>
              ...
              <Button
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-md bg-accent px-3 py-2 font-medium text-secondary"
                type="submit"
              >
