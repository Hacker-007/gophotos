    ...
    <AnimatedPage className="h-full w-full">
      <main className="grid h-full w-full grid-cols-12 gap-5">
        <div className="col-span-5 flex flex-col justify-center">
          ...
          <Link
            href="/waitlist"
            className="group hover:bg-gray-200 mt-10 flex w-fit items-center justify-center rounded-md border border-black py-2 px-3 font-medium"
          >
            ...
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="ml-2 h-6 w-6 flex-shrink-0 group-hover:translate-x-0.5 transition-transform"
            >
              <path
                strokeLinecap="round"
