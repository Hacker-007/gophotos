		...
		<div className={className}>
			...
			<div className="relative rounded-md shadow-sm">
				...
				<input
					...
					name={name}
					id={id}
					className="block w-full h-8 rounded-md border-0 bg-gray-100 px-7 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-700 text-[13px] font-semibold"
					placeholder=""
				/>
			</div>
		</div>
